...
/**
   ...
   Challenge Problem, Robert Kramer PR81 spring 2015
*/
public class IntegerName
{
   ...
   {  
      ...
      while(input <= 0 || input >= 1000) // Validation
              {
                      ...
                      catch(Exception ex){  //Why doesn't it try again.  I got an infinite loop if I don't
                                            //break or return here
                              System.out.println("That was not a valid type.  Please run the program again");
                              return;
